...
from dgl.geometry import farthest_point_sampler # Install DGL first with correct CUDA version
...
def sample_and_group(npoint, radius, nsample, xyz, points, returnfps=False, knn=False):
    ...
    fps_idx = farthest_point_sampler(xyz, npoint) # [B, npoint] # Use DGL's FPS !!
